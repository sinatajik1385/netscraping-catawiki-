...
html_text = requests.get("https://www.catawiki.com/en/c/599-gemstones/932-material/62147-ruby/").text
...
for emerald in emeralds :
    if emerald :
        ...
        with open(f"ruby_number{tracking_number}.txt", "w") as f :
            f.write(f"tracking no : {tracking_number} \n ruby Title: \n {emerald_title} \n ruby URL: \n {emerald_url1} \n ruby description: \n {seller_description} \n example image : \n {emerald_img_src1} \n last bid ammount : \n {list3} \n -------------------------------------------------------")
        print (f'ruby number : {tracking_number}')
