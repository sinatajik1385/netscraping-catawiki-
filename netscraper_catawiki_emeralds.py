...
html_text = requests.get("https://www.catawiki.com/en/c/599-gemstones?932=62160&object_type=18885").text
...
for emerald in emeralds :
    if emerald :
        ...
        with open(f"emerald_number{tracking_number}.txt", "w") as f :
            f.write(f"tracking no : {tracking_number} \n Emerald Title: \n {emerald_title} \n Emerald URL: \n {emerald_url1} \n Emerald description: \n {seller_description} \n example image : \n {emerald_img_src1} \n last bid ammount : \n {list3} \n -------------------------------------------------------")
        print (f'emerald number : {tracking_number}')



    else :
        print("no emmerald for sale")
