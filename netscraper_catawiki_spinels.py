...
html_text = requests.get("https://www.catawiki.com/en/c/599-gemstones/932-material/62152-spinel/").text
...
for emerald in emeralds :
    if emerald :
        ...
        with open(f"spinel_number{tracking_number}.txt", "w") as f :
            f.write(f"tracking no : {tracking_number} \n spinel Title: \n {emerald_title} \n spinel URL: \n {emerald_url1} \n spinel description: \n {seller_description} \n example image : \n {emerald_img_src1} \n last bid ammount : \n {list3} \n -------------------------------------------------------")
        print (f'spinel number : {tracking_number}')
