...
html_text = requests.get("https://www.catawiki.com/en/c/599-gemstones/932-material/62167-hessonite/").text
...
for emerald in emeralds :
    if emerald :
        ...
        with open(f"hessonite_number{tracking_number}.txt", "w") as f :
            f.write(f"tracking no : {tracking_number} \n hessonite Title: \n {emerald_title} \n hessonite URL: \n {emerald_url1} \n hessonite description: \n {seller_description} \n example image : \n {emerald_img_src1} \n last bid ammount : \n {list3} \n -------------------------------------------------------")
        print (f'hessonite number : {tracking_number}')
