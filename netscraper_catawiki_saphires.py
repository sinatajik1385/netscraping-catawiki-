...
html_text = requests.get("https://www.catawiki.com/en/c/599-gemstones/932-material/62148-sapphire/").text
...
for emerald in emeralds :
    if emerald :
        ...
        with open(f"sapphire_number{tracking_number}.txt", "w") as f :
            f.write(f"tracking no : {tracking_number} \n sapphire Title: \n {emerald_title} \n sapphire URL: \n {emerald_url1} \n sapphire description: \n {seller_description} \n example image : \n {emerald_img_src1} \n last bid ammount : \n {list3} \n -------------------------------------------------------")
        print (f'sapphire number : {tracking_number}')
